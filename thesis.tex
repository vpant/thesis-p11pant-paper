...
\prof{Δημήτριος Ρίγγας}{ΕΔΙΠ}{Ιόνιο Πανεπιστήμιο}
...
\chapter{Θεωρητικό υπόβαθρο} \label{chapter:theoretical_background}
\input{theoretical_background}

\chapter{Ανάλυση και Σχεδιασμός συστήματος} \label{chapter:technical_section}
\input{technical_section}
